...
# Bismillah.
# Arabic Parity Sync: Match invocations.json to hisn_id.json using Arabic text from hisn_en.json.
...
def match_and_sync():
    ...
    for file_path in files:
        ...
        print(f"File {file_path}: Matched {matched}/{total} using Arabic parity.")
